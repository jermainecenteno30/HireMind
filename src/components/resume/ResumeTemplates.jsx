  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-800 px-8 py-6 text-white">
        ...
        <p className="text-primary-100 mt-1">Version {resume.version}</p>
      </div>
      ...
      <div className="bg-gray-50 px-8 py-4 border-t border-gray-200">
        <p className="text-xs text-gray-500 text-center">
          Generated by HirePath • {new Date().toLocaleDateString()}
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8">
      <div className="border-b-2 border-gray-200 pb-4 mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Version {resume.version}</p>
      </div>
      ...
      <div className="bg-gray-900 px-8 py-6 text-white">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-400 mt-1">Version {resume.version}</p>
          </div>
          <div className="text-right">
            <p className="text-sm text-gray-400">Created with HirePath</p>
          </div>
        </div>
      </div>
